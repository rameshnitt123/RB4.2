define([],function(){
	...
	function RefreshAccounts(defaultValues){
		var privateState = {};
	...
	BaseModel.isParentOf(RefreshAccounts);
	
	//Create new class level validator object
	BaseModel.Validator.call(RefreshAccounts);
	
	var registerValidatorBackup = RefreshAccounts.registerValidator;
	
	RefreshAccounts.registerValidator = function(){
		var propName = arguments[0];
		if(!setterFunctions[propName].changed){
			var setterBackup = setterFunctions[propName];
			setterFunctions[arguments[0]] = function(){
				if( RefreshAccounts.isValid(this, propName, val) ){
	...
	RefreshAccounts.relations = relations;
	
	RefreshAccounts.prototype.isValid = function(){
		return RefreshAccounts.isValid(this);
	};
	
	RefreshAccounts.prototype.objModelName = "RefreshAccounts";
