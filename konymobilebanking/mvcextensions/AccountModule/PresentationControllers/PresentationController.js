define(["AsyncManager/BusinessControllers/BusinessController", "dataFormatUtility"], function(AsyncManager, dataFormater) {
    ...
    Account_PresentationController.prototype.processAccountsData = function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            accProcessedData[i].accountType=data[i].displayName;
  ...
  Account_PresentationController.prototype.fetchPFMDetails = function(){
    ...
    accountManager.getPFMBarGraphData(year,scope_Acc_Pres.barGraphSuccessCallback,scope_Acc_Pres.barGraphFailureCallback);
    accountManager.getPFMBudgetGraphData(month,year,scope_Acc_Pres.budgetGraphSuccessCallback,scope_Acc_Pres.budgetGraphFailureCallback);
    accountManager.getPFMPieChartData("",year,scope_Acc_Pres.pieChartSuccessCallback,scope_Acc_Pres.pieChartFailureCallback);
  };
  ...
  Account_PresentationController.prototype.pieChartSuccessCallback = function(response){
    var pieData = {};
    var date  = new Date();
  ...
  Account_PresentationController.prototype.navigateToPFMMyMoney = function(){
    var navManager = applicationManager.getNavigationManager();
    var pfmData = {
