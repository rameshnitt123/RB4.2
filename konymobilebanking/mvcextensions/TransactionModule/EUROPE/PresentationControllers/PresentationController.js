...
*/
  ...
  Transaction_PresentationController.prototype.setEntryPoints=function(transactionType)
  {
    ...
    {
      case "InternalTransfer":  navMan.setEntryPoint("makeatransfer","frmTransfersEurope");
        break;
      case "ExternalTransfer":  navMan.setEntryPoint("makeatransfer","frmTransfersEurope");
        break;
      case "P2P":  navMan.setEntryPoint("payaperson","frmTransfersEurope");
        break;
