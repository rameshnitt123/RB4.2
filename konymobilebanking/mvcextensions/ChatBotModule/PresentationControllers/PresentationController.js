  ...
  */
  ChatBot_PresentationController.prototype.showAccountBalance = function(text,message){
    ...
    for(var i=0;i<noOfRecordsToDisplay;i++){
      ...
      var accountType = accountName.substr(0,accountName.indexOf(' ')).toLowerCase();
      switch(accountType)
      {
          case "savings": msg = accountName+" \n\n"+"Available Balance : "+displayBalance;break;
          case "checking": msg = accountName+" \n\n"+"Available Balance : "+displayBalance;break;
          case "creditcard": msg = accountName+" \n\n"+"Current Balance : "+displayBalance;break;
          case "deposit": msg = accountName+" \n\n"+"Current Balance : "+displayBalance;break;
          case "mortgage": msg = accountName+" \n\n"+"Outstanding Balance : "+displayBalance;break;
          case "loan": msg = accountName+" \n\n"+"Outstanding Balance : "+displayBalance;break;
          default: msg = accountName+" \n\n"+"Available Balance : "+displayBalance;break;
      }
      if(i === 0){
