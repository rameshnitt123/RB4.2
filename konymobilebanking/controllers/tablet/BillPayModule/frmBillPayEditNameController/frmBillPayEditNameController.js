define({
    ...
    setFormDataBasedOnEntryPoint: function() {
        ...
        if (flowType === "editBillPay") {
            if (this.isIpad()) {
                this.view.title = kony.i18n.getLocalizedString("kony.mb.AccInfoEdit.Title");
            }
            scope.view.customHeaderTablet.lblHeaderTitle.text = kony.i18n.getLocalizedString("kony.mb.AccInfoEdit.Title");
            scope.view.lblNameTitle.text = kony.i18n.getLocalizedString("Kony.mb.EBill.PayeeNickName");
            scope.view.title = kony.i18n.getLocalizedString("Kony.mb.EBill.PayeeNickName");
            scope.view.btnSave.text = kony.i18n.getLocalizedString("kony.mb.common.save");
            scope.view.txtName.placeholder = kony.i18n.getLocalizedString("kony.tab.PayAPerson.EditNickName");
            ...
            if (this.isIpad()) {
                this.view.title = kony.i18n.getLocalizedString("kony.mb.common.PayeeName");
            }
            scope.view.customHeaderTablet.lblHeaderTitle.text = kony.i18n.getLocalizedString("kony.mb.common.PayeeName");
            scope.view.lblNameTitle.text = kony.i18n.getLocalizedString("kony.mb.common.PayeeName");
            scope.view.txtName.placeholder = kony.i18n.getLocalizedString("kony.tab.billpay.enterName");
            scope.view.btnSave.text = kony.i18n.getLocalizedString("kony.mb.common.continue");
