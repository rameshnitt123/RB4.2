define({
    ...
    btnContinueOnClick: function() {
        ...
        var nameOnBill = this.view.txtNameOnBill.text;
        var billPayMod = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("BillPayModule");
        billPayMod.presentationController.createBillPayPayee(nickName, nameOnBill);
    ...
    mapRightPaneData: function() {
        ...
        var payeeDetails = recipientsManager.getBillPayPayeeData().accountNumber;
        this.view.RightPane.lblCheckedRowName.text = payeeName;
        this.view.RightPane.lblSecondCheckedRowName.text = payeeDetails;
    }
