define({ 
    ...
    "onViewCreated": function() {
     ...
     this.view.flxMainMessage.addGestureRecognizer(constants.GESTURE_TYPE_TAP, {
            fingers: 1
        }, function(widgetRef, gestureInfo, context) {
  ...
  animateLeft : function(rowNumber){
    this.animObj = this.getTransAnimDefinition("-25%");
    kony.application.getCurrentForm().segMessages.animateRows({
      rows: [{
        sectionIndex:0,
        rowIndex: rowNumber
      }],
      widgets: ["flxParentSwipe"],
