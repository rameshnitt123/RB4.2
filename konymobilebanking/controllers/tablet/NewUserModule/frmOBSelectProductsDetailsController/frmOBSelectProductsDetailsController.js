define({ 
  ...
  preShow : function()
  {
    try
    {
      ...
      var navManager = applicationManager.getNavigationManager();
      var productDetailsData = navManager.getCustomInfo("frmOBSelectProducts");
      var productsArray = productDetailsData.products.allProducts;
      var selectedIndex = navManager.getCustomInfo("productTappedToCheckDetails");
      
      var processedProductDetailsData = this.processData(productsArray,selectedIndex);
