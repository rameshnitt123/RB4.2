define({
    ...
    preShow: function() {
      try {
        ...
        this.view.lblAmount.text = String(this.alertData.selectedField).substr(2);
        this.initActions();
      	this.setHeaderTitle(this.alertData);
        this.view.lblBodyText.text = "Enter " + this.alertData.text.toLowerCase();
        this.accountDisplayName = navManager.getCustomInfo("frmAlertsMinimumBalanceAccountTitle");
        this.view.lblAccount.text = this.accountDisplayName;
      ...
      try{
        if(formData.key==="minimumBalance"){
          ...
          this.view.customHeader.lblHeaderTitle.text =  kony.i18n.getLocalizedString("kony.mb.Alerts.MinimumBalanceTitle");
        }
        else if(formData.key==="debitLimit"){
          this.view.title = kony.i18n.getLocalizedString("kony.mb.Alerts.DebitLimitTitle");
          this.view.customHeader.lblHeaderTitle.text =  kony.i18n.getLocalizedString("kony.mb.Alerts.DebitLimitTitle");
        }
        else if(formData.key==="creditLimit"){
          this.view.title = kony.i18n.getLocalizedString("kony.mb.Alerts.CreditLimitTitle");
          this.view.customHeader.lblHeaderTitle.text =  kony.i18n.getLocalizedString("kony.mb.Alerts.CreditLimitTitle");
        }
      }
      catch(err) {
        throw GlobalExceptionHandler.addMessageAndActionForException(err, "kony.error.LoadingFormFailed", GlobalExceptionHandler.ActionConstants.ALERT, arguments.callee.name);
