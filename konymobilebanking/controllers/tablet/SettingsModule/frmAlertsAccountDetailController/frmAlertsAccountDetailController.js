define({
    ...
    setPreshowData: function() {
        try {
            ...
            navManager.setCustomInfo("frmAlertsMinimumBalanceAccountTitle", String(this.singleAccountAlertDetails.accountDisplayName) );
    ...
    initActions: function() {
      try {
        var scope = this;
        this.view.flxToggleSingleAccountAlertsRequired.onClick = this.toggleSingleAccountAlertsRequired;
         ...
         * @return 
         */
        this.view.SegAlertSettingList.onRowClick = function() {
            scope.toggleSegAlertSettingListRowFlag();
        };
  ...
  backNavigation: function(){
    ...
    setSegmentsData: function(singleAccountAlertDetails) {
        try {
            ...
            for (var value in this.alertFields) {
                ...
                tempjson.value =kony.i18n.getLocalizedString("kony.mb.common.currencySymbol") +" "+ singleAccountAlertDetails[value];
    ...
    toggleSegAlertSettingListRowFlag: function() {
        try {
            ...
            var toggle = "true";
            if (selectedData.image.src === "active.png") {
                toggle = "false";
            } else if (selectedData.image.src === "inactive.png") {
                toggle = "true";
            }
    ...
    updateSegAlertSettingListRowFlagSuccess: function(response) {
        try {
            ...
            segData.forEach(function(record) {
                if (record.key === selectedData.key) {
                    if (record.image.src === "active.png") {
                        record.image.src = "inactive.png";
                    } else {
                        record.image.src = "active.png";
