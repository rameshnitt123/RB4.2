  ...
  setMasterDataToSegment: function () {
    ...
    for (var i = 0; i < annualIncome.length; i++) {
      var temp = {"flxMain" : {"skin" : "slFbox"},
                  "lblHyphen" : {"text" : "-"},
                  "lblOption1" : {"text": confManager.getCurrencyCode()+""+annualIncome[i][0]},
                  "lblOption2" : {"text": confManager.getCurrencyCode()+""+annualIncome[i][1]},
    ...
    for (var i = 0; i < segData.length; i++) {
      ...
      segData[i].flxMain.onClick = function () {
        ...
        scope.selectedAnnualIncome = scope.view.segDependents.selectedIndex[1];
