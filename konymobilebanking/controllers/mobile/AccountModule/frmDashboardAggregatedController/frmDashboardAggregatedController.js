define({
    ...
    mapDataToBar: function () {
        ...
        for (p = 0; p < balanceBars.length; p++) {
            var thisBar = "bar" + p;           
            var thisHeight = barGraphData[p];           
            this.barHeights.push(thisHeight);
        ...
        this.view.netWorthTotal2.text = formatUtility.formatAmountandAppendCurrencySymbol(Math.round((2*maxAmount)/3));
        this.view.netWorthTotal3.text = formatUtility.formatAmountandAppendCurrencySymbol(Math.round(maxAmount/3));
   ...
   RotateLablesCalls : function(){
    ...
    animateDashboardFlex: function () {
        ...
        if (scope.view.imgChartSizeToggle.src == "arrowdown.png") {
            ...
            var segMaxHeight = newHeight - 439;// -260 -1 -42 - 1 -60 -75(-segtop-sep-date-sep-btn-toggle)
            newHeight = newHeight - 75 + "dp";
    ...
    pageIndicatorHighlight: function () {
        ...
        if (chartNum === 3 && this.shouldAnimateBar) {
            kony.print("about to call should animate bar fun");
            this.shouldAnimateBar = false;
            this.animateBarChart();
            kony.print("reached scroll end");
        }
    },
...
*/
    ...
    animateBarChart: function () {
        kony.print("animate Bar Chart function called");
        var scope = this;
        var balanceBars = this.view.allBalanceBars.widgets();
