      ...
      try {
        ...
        // If the exceptionObject is null
          if(kony.sdk.isNullOrUndefined(exceptionObject)){
            //#ifdef release
            	alert(kony.i18n.getLocalizedString(GlobalExceptionHandler.StandardErrorMessage));
            //#endif

            //#ifdef debug
            	alert(kony.i18n.getLocalizedString("kony.error.NullThrown"));
            //#endif
        ...
        //If Unhandled Exception / Exception object is thrown as it is without adding extra params to it
          ...
          if(kony.sdk.isNullOrUndefined(exceptionObject.Action)) {
            ...
            //#ifdef debug
            	alert(kony.i18n.getLocalizedString("kony.error.Observing") + exceptionString);
            //#endif
